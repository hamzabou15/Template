...
export const metadata: Metadata = {
  title: "Électricien Carabacel | Urgence 24/7 - Devis Gratuit",
  description: "🔌 Électricien professionnel à Carabacel pour dépannage, installation et rénovation électrique. Service d&apos;urgence 24h/24, 7j/7. Devis gratuit et intervention rapide.",
  keywords: "électricien carabacel, dépannage électrique carabacel, électricien urgence carabacel, rénovation électrique carabacel, installateur électricité carabacel, artisan électricien carabacel",
  authors: [{ name: "Electricien Nice Expert" }],
  metadataBase: new URL('https://electriciennice-expert.fr'),
  alternates: {
    canonical: '/zones/nice/electricien-carabacel',
  },
  openGraph: {
    title: "Électricien Carabacel - Dépannage & Installation - Devis Gratuit",
    description: "Électricien professionnel à Carabacel pour tous travaux électriques. Intervention rapide 24h/24 dans ce quartier résidentiel de Nice.",
    url: 'https://electriciennice-expert.fr/zones/nice/electricien-carabacel',
    siteName: 'Electricien Nice Expert',
    images: [
      {
        url: '/images/carabacel-og.webp',
        width: 1200,
        height: 630,
        alt: 'Électricien professionnel à Carabacel - Intervention rapide',
      },
    ],
    locale: 'fr_FR',
    type: 'website',
...
export default function ElectricienCarabacel() {
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Electrician",
            "name": "Electricien Nice Expert - Carabacel",
            ...
            "url": "https://electriciennice-expert.fr/zones/nice/electricien-carabacel",
            "description": "Électricien professionnel à Carabacel pour dépannage, installation et rénovation électrique. Service d&apos;urgence 24h/24, 7j/7.",
            "areaServed": ["Carabacel", "Rue de France", "Bd Victor Hugo", "Quartier des Musiciens"]
          })
        }}
      />

      {/* Hero Section avec image de fond de Carabacel */}
        ...
        <div className="relative max-w-6xl mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Électricien Professionnel à <span className="text-[#f25000]">Carabacel</span>
            </h1>
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Intervention rapide pour dépannage électrique, installation et rénovation dans le quartier Carabacel à Nice. 
          ...
          <div className="text-center">
            ...
            <p className="text-blue-200 mt-4 text-sm">Appel gratuit - Intervention sous 1h à Carabacel</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Électricien à Carabacel : Expert en Dépannage et Installation
              </h2>
              <p className="text-lg text-gray-700 mb-6">
                Le quartier Carabacel, situé entre la Promenade des Anglais et le boulevard Victor Hugo, 
                présente un mix d&apos;immeubles résidentiels et de commerces. Nos électriciens spécialistes 
                de Carabacel connaissent parfaitement les spécificités de ce quartier animé et central.
              </p>
              <p className="text-lg text-gray-700 mb-6">
                Que vous soyez particulier ou commerçant dans le quartier Carabacel, 
              ...
              <div className="bg-gray-50 p-6 rounded-lg border-l-4 border-[#f25000]">
                <p className="text-gray-700 font-semibold">
                  ...
                  Notre connaissance des particularités des installations électriques de Carabacel 
                  nous permet d&apos;intervenir efficacement dans ce quartier central et animé.
                </p>
              </div>
            </div>
            <div className="relative h-96 rounded-xl overflow-hidden shadow-lg">
              <Image
                src="/images/electricien-carabacel-intervention.webp"
                alt="Électricien professionnel intervenant dans le quartier Carabacel à Nice"
                fill
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-12">
            Nos Services d&apos;Électricité à Carabacel
          </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 mb-4">
                ...
                interviennent rapidement dans tout Carabacel pour résoudre vos problèmes électriques.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center">
                  <CheckCircle size={16} className="text-green-500 mr-2" />
                  <span className="text-gray-600">Intervention sous 1h à Carabacel</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle size={16} className="text-green-500 mr-2" />
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-12">
            Ils nous font confiance à Carabacel
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600 italic mb-4">
                &quot;Intervention rapide pour une panne électrique dans mon appartement de Carabacel. 
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Carabacel</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Commerçante Carabacel</p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-[#1b1e3f] text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Besoin d&apos;un Électricien à Carabacel ?
          </h2>
          <p className="text-xl mb-8">
            Notre équipe d&apos;électriciens qualifiés intervient dans tout le quartier Carabacel 
          ...
          <p className="mt-6 text-blue-200">
            Interventions sur Carabacel, Rue de France, Bd Victor Hugo et tous les secteurs du quartier
          </p>
        </div>
      </section>
    </>
